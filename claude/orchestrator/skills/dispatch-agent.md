...
| `{{FIGMA_URL}}` | `state.json → figma_url` | Figma 设计稿 URL |
| `{{FIGMA_PROMPTS}}` | `cat doc/figma-prompts.md` | Figma 提示词 |
...
| `{{STYLE_GUIDE}}` | `cat docs/design/figma-style-guide.md` | 样式前缀（可选） |
...
| `designer-figma-prompt.txt` | Designer | claude | `/generate-figma-prompt` |
